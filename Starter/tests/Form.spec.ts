...
test('Form is submitted with required fields filled - practice', async ({ page }) => {
...
test('Form is not submitted with required fields empty, form is cleared after submit - practice', async ({ page }) => {
...
test('Form is not submitted with required fields empty - practice', async ({ page }) => {
    let formSubmitted = false;
    page.on('dialog', async dialog => {
        await dialog.accept();
        formSubmitted = true;
